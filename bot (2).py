...
BOT_USERNAME = "SendTchekBot"  # Додано правильне ім'я бота
...
""",
        "profile_caption": (
            ...
            "https://t.me/@SendTchekBot?start=ref_{user_id}\n\n"
            "📊 Статистика\n"
            "📦 Успешных заказов: 0\n"
            "⭐️ Куплено звёзд: 0"
        ),
        "terms_caption": (
            "Условия использования @SendTchekBot:\n\n"
            ...
            "С уважением, команда @SendTchekBot."
        ),
        "stars_caption": (
            ...
            "4. ✍️ Введите имя бота @SendTchekBot и нажмите Добавить.\n"
        ...
        "check_result": (
            ...
            "Спасибо за использование @SendTchekBot!"
        )
    }
}
...
async def main():
    print("💖 Зроблено з любов'ю Vozik")
